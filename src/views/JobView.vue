...
const deleteJob = async () => {
  try {
    const confirm = window.confirm(
      'Are you sure you want to delete this job? This action cannot be reversed.',
    )
    if (confirm) {
...
<template>
  ...
  <section class="bg-green-50">
    ...
    <div
      v-else
      className="flex items-center justify-center text-center text-gray-500 py-6 h-[calc(100vh-81px)]"
    >
      <PulseLoader />
    </div>
  </section>
